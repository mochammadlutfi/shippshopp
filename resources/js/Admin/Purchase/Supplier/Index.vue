    ...
    <base-layout>
        <div class="content">
            <div class="content-heading d-flex justify-content-between align-items-center">
                <span>Supplier</span>
                <div class="space-x-1">
                    <a :href="route('admin.purchase.supplier.create')" class="ep-button ep-button--primary">
                            ...
                            <template #default="scope">
                                <el-dropdown popper-class="dropdown-action" trigger="click">
                                    ...
                                    <template #dropdown>
                                        <el-dropdown-menu>
                                            <el-dropdown-item>
                                                <a :href="route('admin.purchase.supplier.edit', {id : scope.row.id})" class="w-100 d-flex align-items-center justify-content-between space-x-1">
                                                Ubah
...
const hapus = (id) => {
  ElMessageBox.alert('Data yang dihapus tidak bisa dikembalikan!', 'Peringatan', {
    ...
    router.delete(`/admin/supplier/${id}/delete`, {
      preserveScroll: true,
      onSuccess: () => {
        fetchData();
        ElMessage({
